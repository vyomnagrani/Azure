...
| 502/503 errors | Ingress misconfiguration | Check targetPort and app listen port |
| Scaling not working | KEDA scaler misconfigured | See [scaling-issues.md](scaling-issues.md) |
| Dapr sidecar errors | Component binding issues | See [dapr-troubleshooting.md](dapr-troubleshooting.md) |
| VNet connectivity | Network rules blocking | See [networking.md](networking.md) |
| Stuck revision | Provisioning error | See [revision-management.md](revision-management.md) |
...
- [Networking & Connectivity](networking.md) — VNet, custom domains, TLS, session affinity
- [Scaling Issues](scaling-issues.md) — KEDA, scale-to-zero, replica limits
- [Dapr Troubleshooting](dapr-troubleshooting.md) — Sidecars, service invocation, bindings
- [KQL Queries for Container Apps](kql-container-apps.md) — Log Analytics queries
- [Revision Management](revision-management.md) — Traffic splitting, stuck revisions

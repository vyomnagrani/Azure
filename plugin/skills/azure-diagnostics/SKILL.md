...
- Troubleshoot Container Apps networking, Dapr, scaling, or revision issues
...
| **Container Apps** | Networking, VNet, custom domains, TLS | [networking.md](references/container-apps/networking.md) |
| **Container Apps** | Scaling failures, KEDA misconfiguration | [scaling-issues.md](references/container-apps/scaling-issues.md) |
| **Container Apps** | Dapr sidecar, service invocation, bindings | [dapr-troubleshooting.md](references/container-apps/dapr-troubleshooting.md) |
| **Container Apps** | KQL queries for Container Apps logs | [kql-container-apps.md](references/container-apps/kql-container-apps.md) |
| **Container Apps** | Revision activation, traffic splitting | [revision-management.md](references/container-apps/revision-management.md) |
...
See [kql-container-apps.md](references/container-apps/kql-container-apps.md) for Container Apps-specific queries.

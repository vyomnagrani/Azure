...
Serverless container hosting for microservices, APIs, background workers, and jobs.
...
- Scheduled tasks and batch processing (Container Apps Jobs)
...
| Scheduled Job | None | 0 | Cron schedule |
| Event-Driven Job | None | 0 | Event trigger (KEDA) |
| Manual Job | None | 0 | On-demand |
